...
(function () {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => init().catch(err => console.error('[FQC00014]', err)));
  } else {
    init().catch(err => console.error('[FQC00014]', err));
  }
})();
