...
public partial class FosdOrderMain
{
    ...
    public int? LastSerialNum { get; set; }
    public int PaperType { get; set; }
    public string? RwkRoute { get; set; }
    public string? DProcCode { get; set; }
    public string? FactorId { get; set; }
    public int IsMassLam { get; set; }
    public string? PriorRecPaperNum { get; set; }
    public string? PriorPassPaperNum { get; set; }
    public int OSType { get; set; }
    public string? BackToAddress { get; set; }
    public int? IsPreBuild { get; set; }
    ...
    public string? NotesJH { get; set; }
    public string? LineId { get; set; }
    public string? SignNotes { get; set; }
    public int WpnlToPcs { get; set; }
}
