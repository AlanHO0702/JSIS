...
namespace PcbErpApi.Pages.ABE
{
    public class ABEdBillInqModel : PageModel
    {
        private readonly PcbErpContext _context;
        private readonly PaginationService _pagedService;
        private readonly ITableDictionaryService _dictService;

        public ABEdBillInqModel(PcbErpContext context, PaginationService pagedService, ITableDictionaryService dictService)
        {
            _context = context;
        ...
        public string PageTitle => "ABE00004 票據查詢";
        ...
        public async Task<IActionResult> OnGetExportAsync()
        {
            ...
            try
            {
                ...
                var ws = wb.AddWorksheet("ABE00004");
                ...
                var fileName = $"ABE00004_{DateTime.Now:yyyyMMdd}.xlsx";
