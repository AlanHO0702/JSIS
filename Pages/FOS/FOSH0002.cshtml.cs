...
{
    public class FOSH0002Model : PageModel
    {
        private readonly PcbErpContext _context;
        private readonly PaginationService _pagedService;
        private readonly ITableDictionaryService _dictService;

        public FOSH0002Model(PcbErpContext context, PaginationService pagedService, ITableDictionaryService dictService)
        {
            _context = context;
        ...
        public string PageTitle => "FOSH0002 委外出廠單查詢";
        ...
        public async Task<IActionResult> OnGetExportAsync()
        {
            ...
            try
            {
                ...
                var ws = wb.AddWorksheet("FOSH0002");
                ...
                var fileName = $"FOSH0002_{DateTime.Now:yyyyMMdd}.xlsx";
