...
namespace PcbErpApi.Pages.FOS
{
    public class FOSH0003Model : PageModel
    {
        private readonly PcbErpContext _context;
        private readonly PaginationService _pagedService;
        private readonly ITableDictionaryService _dictService;

        public FOSH0003Model(PcbErpContext context, PaginationService pagedService, ITableDictionaryService dictService)
        {
            _context = context;
        ...
        public string PageTitle => "FOSH0003 委外回廠單查詢";
        ...
        public async Task OnGetAsync()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(className))
                    className = "FOSdReceiveInq";

                ParamTableName = $"{className}Params";
        ...
        public async Task<IActionResult> OnGetExportAsync()
        {
            ...
            try
            {
                ...
                var ws = wb.AddWorksheet("FOSH0003");
                ...
                var fileName = $"FOSH0003_{DateTime.Now:yyyyMMdd}.xlsx";
