...
{
    public class FOSH0004Model : PageModel
    {
        private readonly PcbErpContext _context;
        private readonly PaginationService _pagedService;
        private readonly ITableDictionaryService _dictService;

        public FOSH0004Model(PcbErpContext context, PaginationService pagedService, ITableDictionaryService dictService)
        {
            _context = context;
        ...
        public string PageTitle => "FOSH0004 委外結帳單查詢";
        ...
        public async Task<IActionResult> OnGetExportAsync()
        {
            ...
            try
            {
                ...
                var ws = wb.AddWorksheet("FOSH0004");
                ...
                var fileName = $"FOSH0004_{DateTime.Now:yyyyMMdd}.xlsx";
