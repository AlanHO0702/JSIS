...
public abstract class TableSingleGrid<T> : PageModel where T : class, new() // 泛型抽象類別，限制 T 為可實例化的類別
{ // 開始類別定義
    ...
    public TableSingleGrid(IHttpClientFactory httpClientFactory, ITableDictionaryService dictService) // 建構子注入依賴
    { // 建構子開始
