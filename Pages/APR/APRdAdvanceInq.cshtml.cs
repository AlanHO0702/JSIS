...
{
    public class APRdAdvanceInqModel : PageModel
    {
        private readonly PcbErpContext _context;
        private readonly PaginationService _pagedService;
        private readonly ITableDictionaryService _dictService;

        public APRdAdvanceInqModel(PcbErpContext context, PaginationService pagedService, ITableDictionaryService dictService)
        {
            _context = context;
        ...
        /// <summary>ARM00020=預收款查詢, QU000047=預付款查詢</summary>
        [BindProperty(SupportsGet = true, Name = "itemId")]
        public string ItemIdParam { get; set; } = "ARM00020";

        public string ResolvedItemId => string.IsNullOrWhiteSpace(ItemIdParam) ? "ARM00020" : ItemIdParam.Trim();
        ...
        // Detail dict fields (single tab: 單據資料)
        ...
        public async Task OnGetAsync()
        {
            ...
            try
            {
                ...
                PageTitle = itemId == "QU000047" ? "QU000047 預付款查詢" : "ARM00020 預收款查詢";
                ...
                // Load detail dict fields (Delphi qryDetail.TableName = 'APRdPRSubInq')
        ...
        /// <summary>單據資料 (Delphi qryDetail): APRdAdvanceSub + AJNdAccId + AJNdSubAccId</summary>
...
from APRdAdvanceSub t1 with (nolock),
