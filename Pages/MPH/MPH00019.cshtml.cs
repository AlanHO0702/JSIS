...
{
    public class MPH00019Model : PageModel
    {
        private const string ItemId = "MPH00019";
        private const string DictTable = "MPHdV_InvoiceInq";
        private readonly PcbErpContext _context;

        public MPH00019Model(PcbErpContext context)
        {
            _context = context;
        }

        public string PageTitle => "MPH00019 廠商發票查詢";
        ...
        private static async Task<HashSet<string>> GetAllowedColumnsAsync(DbConnection conn)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select COLUMN_NAME from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'MPHdV_InvoiceInq'";
